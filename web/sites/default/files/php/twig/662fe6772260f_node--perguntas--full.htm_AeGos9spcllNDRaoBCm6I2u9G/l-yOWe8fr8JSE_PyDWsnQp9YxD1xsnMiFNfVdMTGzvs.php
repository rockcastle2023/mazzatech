...
/* themes/custom/test_theme/templates/node/node--perguntas--full.html.twig */
class __TwigTemplate_0a5a2ae46413d8ae85f8c30240d216c2 extends Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (\Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 75, $this->source))) : ("")), 5 => "clearfix"];
  ...
  <div class=\"btn-save-resp\">
    <a class=\"btn btn-primary\" href=\"#\" role=\"button\" id=\"salvarResp\" disabled=\"disabled\">Responder</a>
  </div>
...
";
    ...
    {
        return "themes/custom/test_theme/templates/node/node--perguntas--full.html.twig";
    }
...
", "themes/custom/test_theme/templates/node/node--perguntas--full.html.twig", "/app/web/themes/custom/test_theme/templates/node/node--perguntas--full.html.twig");
    }
